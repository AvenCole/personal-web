<template>
  <div
    ref="iconRef"
    class="flex aspect-square w-fit cursor-pointer items-center justify-center rounded-full transition-all duration-200 ease-out"
    :style="{
      width: `${iconWidth}px`,
      height: `${iconWidth}px`,
    }"
...
function calculateDistance(value: number) {
  if (isVertical.value) {
